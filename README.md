...
# 9. Install NGINX Ingress Controller (if not installed)
...
# 11. Add entry to /etc/hosts
sudo nano /etc/hosts
# Add:
127.0.0.1 three-tier-app.local

# 12. Access application via Ingress
kubectl port-forward svc/ingress-nginx-controller 8080:80 -n ingress-nginx
# Open in browser:
http://three-tier-app.local:8080
```
